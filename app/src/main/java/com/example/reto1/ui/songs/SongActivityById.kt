...
class SongActivityById: ComponentActivity() {

    private lateinit var songIdAdapter: SongAdapterId
    private val songRepository = RemoteSongsDataSource();
  /*  private val viewModel: SongViewModelById by viewModels {
        SongsViewModelById.SongIdViewModelFactory(songRepository)
    }
